        ...
        <>
            {data.eventType.length === 0 ? (
                <EmptyState
                    ...
                    description="You can create yuor first event type by clicking the button below."
                    buttonText="Add evnt type"
                    href="/dashboard/new"
                />
            ) : (
                <>
                    <div className="flex items-center justify-between px-2">
                        <div className="hidden sm:grid gap-y-1">
                            <h1 className="text3xl md:text-4xl font-semibold">Event Types</h1>
                    ...
                    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                        {data.eventType.map((item) => (
                            <div className="overflow-hidden shadow rounded-lg border relative" key={item.id}>
                                ...
                                <Link href={`/dashboard/${item.id}`} className="flex items-center p-5">
